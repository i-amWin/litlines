        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            <a
              ...
              className="inline-flex items-center px-3.5 py-2 text-sm font-medium text-center text-white rounded-lg focus:ring-4 focus:outline-none bg-blue-600 hover:bg-blue-700 focus:ring-blue-800"
              target="_blank"
            ...
            <div className="flex items-center">
              ...
              <span className="text-xs font-semibold mr-2 px-2.5 py-0.5 rounded bg-blue-200 text-blue-800 ml-1">
